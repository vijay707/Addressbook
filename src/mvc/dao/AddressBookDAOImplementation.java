    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getDepartment()+"')";
       ...
       catch(SQLException e)
       {
           ...
           //JOptionPane.showMessageDialog(new JFrame(), "Incorrect Mobile number","Inane error", JOptionPane.ERROR_MESSAGE);
       }
    ...
    @Override
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           String qry="update AddressBook set name='"+person.getName()+"',mobile='"+person.getMob()+"',email='"+person.getEmail()+"',department='"+person.getDepartment()+"' where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            conn.close();
                   ...
                   System.out.println("NO Records/Cannot retrieve records "+ex);
                   }
    }
    ...
    public DefaultListModel getSearchNames(NameListPanel namePanel, String searchcon) {
     ...
     conn = DBConnection.getInstance().getConnect();
       ...
       conn.close();
               ...
               //JOptionPane.showMessageDialog(new JFrame(), "No Records Found","error", JOptionPane.ERROR_MESSAGE);
               }
